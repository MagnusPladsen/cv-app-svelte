...
<div class="flex flex-col gap-2">
	...
	<FormInput label="Full name" name="name" containerClass="w-full" bind:value={cv.name} />
	<FormInput label="Position" name="position" containerClass="w-full" bind:value={cv.position} />
	<FormInput
		label="About you"
		name="about"
		textArea
