...
<form>
	<div
		class="flex min-h-screen flex-row justify-between gap-8 bg-gradient-to-r from-teal-700 to-gray-900 px-8 pb-20 pt-8 text-white"
	>
		<div class="flex min-h-screen w-full max-w-[600px] flex-col gap-4">
			<Header />
			<Colors />
